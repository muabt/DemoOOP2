package Buoi6tinhDaHinhTruuTuongExercise.Bai3;

import java.util.Scanner;

public class Main {
    public static void main(String[] args) {
        //TamGiac t1 = new TamGiac(new long[]{3, 4, 5});
        //System.out.println("Chu vi %d cm, dien tich %.2f cm2 \n", t1.tinhChuVi(), t1.tinhDienTich());
